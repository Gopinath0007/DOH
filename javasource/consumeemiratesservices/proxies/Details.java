...
public class Details
{
	 ...
	 */
	public static final java.lang.String entityName = "ConsumeEmiratesServices.Details";
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "ConsumeEmiratesServices.Details"));
	}
	...
	protected Details(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject detailsMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("ConsumeEmiratesServices.Details", detailsMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a ConsumeEmiratesServices.Details");
	...
	public static consumeemiratesservices.proxies.Details initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return consumeemiratesservices.proxies.Details.load(context, mendixIdentifier);
	}
	 ...
	 */
	public static consumeemiratesservices.proxies.Details initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new consumeemiratesservices.proxies.Details(context, mendixObject);
	}

	public static consumeemiratesservices.proxies.Details load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return consumeemiratesservices.proxies.Details.initialize(context, mendixObject);
	}

	public static java.util.List<consumeemiratesservices.proxies.Details> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		java.util.List<consumeemiratesservices.proxies.Details> result = new java.util.ArrayList<consumeemiratesservices.proxies.Details>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//ConsumeEmiratesServices.Details" + xpathConstraint))
			result.add(consumeemiratesservices.proxies.Details.initialize(context, obj));
		return result;
	}
	...
	public boolean equals(Object obj)
	{
		...
		{
			final consumeemiratesservices.proxies.Details that = (consumeemiratesservices.proxies.Details) obj;
	...
	{
		return "ConsumeEmiratesServices.Details";
	}
