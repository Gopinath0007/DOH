...
public class Microflows
{
	...
	public static void aCT_CheckProfessionalUserRole(IContext context, administration.proxies.Account _account, administration.proxies.AccountPasswordData _accountPasswordData)
	{
		...
		Core.microflowCall("Administration.ACT_CheckProfessionalUserRole").withParams(params).execute(context);
	}
