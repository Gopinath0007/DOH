...
public class FileDocument
{
	...
	public static system.proxies.FileDocument initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		...
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.Certificate", mendixObject.getType()))
			return myfirstmodule.proxies.Certificate.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.Circulardoc", mendixObject.getType()))
		...
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.Document", mendixObject.getType()))
		...
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.Payment_Docs", mendixObject.getType()))
		...
		if (com.mendix.core.Core.isSubClassOf("RequestforPreliminaryRegistrationofaFacility_Hospital.UploadDocuments", mendixObject.getType()))
		...
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.excel_", mendixObject.getType()))
