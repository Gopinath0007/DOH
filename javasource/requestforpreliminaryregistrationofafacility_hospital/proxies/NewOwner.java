...
{
	private final com.mendix.systemwideinterfaces.core.IMendixObject newOwnerMendixObject;
	 ...
	 */
	public static final java.lang.String entityName = "RequestforPreliminaryRegistrationofaFacility_Hospital.NewOwner";
	...
	public enum MemberNames
	{
		...
		NewOwner_Preliminary("RequestforPreliminaryRegistrationofaFacility_Hospital.NewOwner_Preliminary");
	...
	public NewOwner(com.mendix.systemwideinterfaces.core.IContext context)
	{
		this(context, com.mendix.core.Core.instantiate(context, "RequestforPreliminaryRegistrationofaFacility_Hospital.NewOwner"));
	}

	protected NewOwner(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject newOwnerMendixObject)
	{
		if (newOwnerMendixObject == null)
			throw new java.lang.IllegalArgumentException("The given object cannot be null.");
		if (!com.mendix.core.Core.isSubClassOf("RequestforPreliminaryRegistrationofaFacility_Hospital.NewOwner", newOwnerMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a RequestforPreliminaryRegistrationofaFacility_Hospital.NewOwner");

		this.newOwnerMendixObject = newOwnerMendixObject;
		this.context = context;
	}

	/**
	 * @deprecated Use 'NewOwner.load(IContext, IMendixIdentifier)' instead.
	 */
	@java.lang.Deprecated
	public static requestforpreliminaryregistrationofafacility_hospital.proxies.NewOwner initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return requestforpreliminaryregistrationofafacility_hospital.proxies.NewOwner.load(context, mendixIdentifier);
	}
	 ...
	 */
	public static requestforpreliminaryregistrationofafacility_hospital.proxies.NewOwner initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new requestforpreliminaryregistrationofafacility_hospital.proxies.NewOwner(context, mendixObject);
	}

	public static requestforpreliminaryregistrationofafacility_hospital.proxies.NewOwner load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return requestforpreliminaryregistrationofafacility_hospital.proxies.NewOwner.initialize(context, mendixObject);
	}

	public static java.util.List<requestforpreliminaryregistrationofafacility_hospital.proxies.NewOwner> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		java.util.List<requestforpreliminaryregistrationofafacility_hospital.proxies.NewOwner> result = new java.util.ArrayList<requestforpreliminaryregistrationofafacility_hospital.proxies.NewOwner>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//RequestforPreliminaryRegistrationofaFacility_Hospital.NewOwner" + xpathConstraint))
			result.add(requestforpreliminaryregistrationofafacility_hospital.proxies.NewOwner.initialize(context, obj));
		return result;
	}
	...
	/**
	 * Set value of OwnerType
	 * @param ownertype
	 */
	public final requestforpreliminaryregistrationofafacility_hospital.proxies.ENUM_OwnerType getOwnerType()
	{
		return getOwnerType(getContext());
	}

	/**
	 * @param context
	 * @return value of OwnerType
	 */
	public final requestforpreliminaryregistrationofafacility_hospital.proxies.ENUM_OwnerType getOwnerType(com.mendix.systemwideinterfaces.core.IContext context)
	{
		Object obj = getMendixObject().getValue(context, MemberNames.OwnerType.toString());
		if (obj == null)
			return null;

		return requestforpreliminaryregistrationofafacility_hospital.proxies.ENUM_OwnerType.valueOf((java.lang.String) obj);
	}
	 ...
	 * @param ownertype
	 */
	public final void setOwnerType(requestforpreliminaryregistrationofafacility_hospital.proxies.ENUM_OwnerType ownertype)
	{
		setOwnerType(getContext(), ownertype);
	}
	 ...
	 * @param ownertype
	 */
	public final void setOwnerType(com.mendix.systemwideinterfaces.core.IContext context, requestforpreliminaryregistrationofafacility_hospital.proxies.ENUM_OwnerType ownertype)
	{
		if (ownertype != null)
			getMendixObject().setValue(context, MemberNames.OwnerType.toString(), ownertype.toString());
		else
			getMendixObject().setValue(context, MemberNames.OwnerType.toString(), null);
	}
	...
	/**
	 * @return value of TermsAndConditions
	 */
	public final java.lang.Boolean getTermsAndConditions()
	{
		return getTermsAndConditions(getContext());
	}
	 ...
	 * @return value of TermsAndConditions
	 */
	public final java.lang.Boolean getTermsAndConditions(com.mendix.systemwideinterfaces.core.IContext context)
	{
		return (java.lang.Boolean) getMendixObject().getValue(context, MemberNames.TermsAndConditions.toString());
	}

	/**
	 * Set value of TermsAndConditions
	 * @param termsandconditions
	 */
	public final void setTermsAndConditions(java.lang.Boolean termsandconditions)
	{
		setTermsAndConditions(getContext(), termsandconditions);
	}
	 ...
	 * @param termsandconditions
	 */
	public final void setTermsAndConditions(com.mendix.systemwideinterfaces.core.IContext context, java.lang.Boolean termsandconditions)
	{
		getMendixObject().setValue(context, MemberNames.TermsAndConditions.toString(), termsandconditions);
	}

	/**
	 * @return value of NewOwner_Preliminary
	 */
	public final requestforpreliminaryregistrationofafacility_hospital.proxies.Preliminary getNewOwner_Preliminary() throws com.mendix.core.CoreException
	{
		return getNewOwner_Preliminary(getContext());
	}
	 ...
	 * @return value of NewOwner_Preliminary
	 */
	public final requestforpreliminaryregistrationofafacility_hospital.proxies.Preliminary getNewOwner_Preliminary(com.mendix.systemwideinterfaces.core.IContext context) throws com.mendix.core.CoreException
	{
		requestforpreliminaryregistrationofafacility_hospital.proxies.Preliminary result = null;
		com.mendix.systemwideinterfaces.core.IMendixIdentifier identifier = getMendixObject().getValue(context, MemberNames.NewOwner_Preliminary.toString());
		if (identifier != null)
	...
	/**
	 * Set value of NewOwner_Preliminary
	 * @param newowner_preliminary
	 */
	public final void setNewOwner_Preliminary(requestforpreliminaryregistrationofafacility_hospital.proxies.Preliminary newowner_preliminary)
	{
		setNewOwner_Preliminary(getContext(), newowner_preliminary);
	}
	 ...
	 * @param newowner_preliminary
	 */
	public final void setNewOwner_Preliminary(com.mendix.systemwideinterfaces.core.IContext context, requestforpreliminaryregistrationofafacility_hospital.proxies.Preliminary newowner_preliminary)
	{
		if (newowner_preliminary == null)
			getMendixObject().setValue(context, MemberNames.NewOwner_Preliminary.toString(), null);
		else
			getMendixObject().setValue(context, MemberNames.NewOwner_Preliminary.toString(), newowner_preliminary.getMendixObject().getId());
	}
	...
	public boolean equals(Object obj)
	{
		...
		{
			final requestforpreliminaryregistrationofafacility_hospital.proxies.NewOwner that = (requestforpreliminaryregistrationofafacility_hospital.proxies.NewOwner) obj;
	...
	{
		return "RequestforPreliminaryRegistrationofaFacility_Hospital.NewOwner";
	}
