...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "65a7caabe63576e3ee4d";
...
/******/ 	return hotCreateRequire("./src/ReactDateTimePicker.tsx")(__webpack_require__.s = "./src/ReactDateTimePicker.tsx");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/ui/ReactDateTimePicker.css":
/*!*********************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/ui/ReactDateTimePicker.css ***!
  \*********************************************************************************************************************/
/*! no static exports found */
		...
		tableChildren = [
			React.createElement('thead', { key: 'th' }, [
				React.createElement('tr', { key: 'h' }, [
					...
					React.createElement('th', { key: 's', className: 'rdtSwitch', onClick: this.props.showView( 'months' ), colSpan: this.props.showWeekNumbers ? 6 : 5, 'data-value': this.props.viewDate.month() }, locale.months( date ) + ' ' + date.year() ),
	...
	renderDays: function() {
		...
		while ( prevMonth.isBefore( lastDay ) ) {
			...
			if ( days.length === 7 ) {
				...
				if (showWeekNumbers) {
					days.unshift(React.createElement('td',  {className:'weekNumber'}, currentDate.week()));
				}
	...
	renderFooter: function() {
		...
		return React.createElement('tfoot', { key: 'tf'},
			React.createElement('tr', {},
				React.createElement('td', { onClick: this.props.showView( 'time' ), colSpan: this.props.showWeekNumbers ? 8 : 7, className: 'rdtTimeToggle' }, date.format( this.props.timeFormat ))
			)
		);
	},
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_ReactDateTimePickerUI__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/ReactDateTimePickerUI */ "./src/components/ReactDateTimePickerUI.tsx");
...
/* harmony import */ var _ui_ReactDateTimePicker_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ui/ReactDateTimePicker.css */ "./src/ui/ReactDateTimePicker.css");
/* harmony import */ var _ui_ReactDateTimePicker_css__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_ui_ReactDateTimePicker_css__WEBPACK_IMPORTED_MODULE_4__);
...
var ReactDateTimePicker = /** @class */ (function (_super) {
    __extends(ReactDateTimePicker, _super);
    function ReactDateTimePicker() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.onBlurHandle = _this.onBlur.bind(_this);
        return _this;
    }
    //On leave of the datepicker, set the attribute to the selected date
    ReactDateTimePicker.prototype.onBlur = function (dateTimeSelected) {
    ...
    ReactDateTimePicker.prototype.setInvalidDateAttribute = function (newValue) {
    ...
    ReactDateTimePicker.prototype.render = function () {
        // determine placeholder
        var placeholder = typeof this.props.placeholder === 'undefined' ? "" : this.props.placeholder.value;
        ...
        var locale = typeof this.props.locale === 'undefined' || this.props.locale.value === "" ? undefined : this.props.locale.value;
        ...
        var dateTimeValue = typeof this.props.dateTimeAttribute.value === 'undefined' ? undefined : moment__WEBPACK_IMPORTED_MODULE_2___default()(this.props.dateTimeAttribute.value);
        //determine min and max date (can be undefined and value can be undefined)
        var minDate = typeof this.props.minDateAttribute === 'undefined' ? undefined :
            typeof this.props.minDateAttribute.value === 'undefined' ? undefined : moment__WEBPACK_IMPORTED_MODULE_2___default()(this.props.minDateAttribute.value);
        var maxDate = typeof this.props.maxDateAttribute === 'undefined' ? undefined :
            typeof this.props.maxDateAttribute.value === 'undefined' ? undefined : moment__WEBPACK_IMPORTED_MODULE_2___default()(this.props.maxDateAttribute.value);
        // set the initial view data if provided (can be undefined)
        var initialViewDate = typeof this.props.initialViewDateAttribute === 'undefined' ? undefined :
            typeof this.props.initialViewDateAttribute.value === 'undefined' ? undefined : moment__WEBPACK_IMPORTED_MODULE_2___default()(this.props.initialViewDateAttribute.value);
        // if widget is readOnly and show as text, only show the text
        var disabled = this.props.dateTimeAttribute.readOnly;
        var readOnlyAsText = disabled && this.props.readOnlyStyle === 'text';
...
var Alert = function (_a) {
    ...
    return children ? (Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", { id: id, className: classnames__WEBPACK_IMPORTED_MODULE_1___default()("alert alert-" + alertStyle + " mx-validation-message", className) }, children)) : null;
};
...
/***/ "./src/components/ReactDateTimePickerUI.tsx":
/*!**************************************************!*\
  !*** ./src/components/ReactDateTimePickerUI.tsx ***!
  \**************************************************/
/*! exports provided: ReactDateTimeUI */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ReactDateTimeUI", function() { return ReactDateTimeUI; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_datetime__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-datetime */ "./node_modules/react-datetime/DateTime.js");
...
var ReactDateTimeUI = /** @class */ (function (_super) {
    __extends(ReactDateTimeUI, _super);
    function ReactDateTimeUI() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.onBlurHandle = _this.onBlur.bind(_this);
        _this.onChangeHandle = _this.onChange.bind(_this);
        _this.onFocusHandle = _this.onFocus.bind(_this);
        _this.OnButtonClickHandle = _this.openCalendar.bind(_this);
        _this.closeDate = Date.now();
        _this.state = {
            value: undefined
        };
        return _this;
    }
    ReactDateTimeUI.prototype.onBlur = function (dateTimeSelected) {
        //on leave, call onclick method and pass the selected datetime
        this.closeDate = Date.now();
        this.props.onBlur(dateTimeSelected);
    };
    ReactDateTimeUI.prototype.onChange = function (dateTimeSelected) {
        this.setState({ value: dateTimeSelected });
    };
    ReactDateTimeUI.prototype.componentDidUpdate = function (prevProps) {
    ...
    ReactDateTimeUI.prototype.componentDidMount = function () {
        this.setState({ value: this.props.dateTimeValue });
    };
    ReactDateTimeUI.prototype.onFocus = function () {
        //When button is clicked, open the calendar
        this.datetimeRef.openCalendar();
    };
    ReactDateTimeUI.prototype.openCalendar = function () {
        //if button is clicked, first onBlur is triggered, so when this is the case, the calendar should not be opened
        var timeElapsed = Date.now() - this.closeDate;
        if (timeElapsed > 100) {
            this.datetimeRef.openCalendar();
        }
    };
    ReactDateTimeUI.prototype.render = function () {
        var _this = this;
        // specify placeholder and disabled property in inputprops
        var inputProps = { placeholder: this.props.placeholder, disabled: this.props.disabled };
        // Set time contrains (min, max and step)
        var timeConstraints = { seconds: { min: this.props.minSeconds, max: this.props.maxSeconds, step: this.props.secondStep },
        ...
        if (this.props.disablePast || typeof this.props.minDate !== 'undefined' || typeof this.props.maxDate !== 'undefined') {
            ...
            validDate = function (currentDate) {
                ...
                //check if date is in the past
                if (disablePast) {
                    valid = currentDate.isAfter(yesterDayMoment_1);
                }
        ...
        var classNamesButton = "btn mx-button spacing-outer-left";
        var classNameDiv = "mx-compound-control";
        ...
        return Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null,
            Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", { className: classNameDiv },
                Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(react_datetime__WEBPACK_IMPORTED_MODULE_1___default.a, { onBlur: this.onBlurHandle, onChange: this.onChangeHandle, onFocus: this.onFocusHandle, inputProps: inputProps, timeConstraints: timeConstraints, timeFormat: this.props.timeFormat, dateFormat: this.props.dateFormat, closeOnSelect: this.props.closeOnSelect, locale: this.props.locale, isValidDate: validDate, value: this.state.value, viewDate: this.props.initialViewDate, ref: function (ref) {
                        _this.datetimeRef = ref;
                    }, showWeekNumbers: this.props.showWeekNumbers }),
                this.props.readOnlyAsText ? undefined :
                    Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])("button", { type: "button", className: classNamesButton, onClick: this.OnButtonClickHandle },
                        Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])("span", { className: "glyphicon glyphicon-calendar" }))));
    };
    return ReactDateTimeUI;
}(react__WEBPACK_IMPORTED_MODULE_0__["Component"]));
...
/***/ "./src/ui/ReactDateTimePicker.css":
/*!****************************************!*\
  !*** ./src/ui/ReactDateTimePicker.css ***!
  \****************************************/
/*! no static exports found */
...
var content = __webpack_require__(/*! !../../node_modules/css-loader/dist/cjs.js!../../node_modules/sass-loader/dist/cjs.js!./ReactDateTimePicker.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/ui/ReactDateTimePicker.css");
...
if(true) {
	module.hot.accept(/*! !../../node_modules/css-loader/dist/cjs.js!../../node_modules/sass-loader/dist/cjs.js!./ReactDateTimePicker.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/ui/ReactDateTimePicker.css", function() {
		var newContent = __webpack_require__(/*! !../../node_modules/css-loader/dist/cjs.js!../../node_modules/sass-loader/dist/cjs.js!./ReactDateTimePicker.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/ui/ReactDateTimePicker.css");
...
//# sourceMappingURL=ReactDateTimePicker.js.map